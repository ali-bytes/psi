<%@ Page Title="<%$Resources:Tokens,TransferBetweenSavesRequest%>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="TransferBetweenSavesRequest.aspx.cs" Inherits="NewIspNL.Pages.TransferBetweenSavesRequest" %>
    ...
    <div class="view">
        <fieldset>
            <div class="page-header">
                <h1>
                    <asp:Literal ID="Literal1" Text="<%$Resources:Tokens,TransferBetweenSavesRequest %>" runat="server" /></h1>
            </div>
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right">
                                <asp:Literal ID="Literal4" runat="server" Text="<%$Resources:Tokens,TransferFrom %>"></asp:Literal></label>
                            <div class="col-sm-9">
                                <div>
                                    <div>
                                        <asp:DropDownList runat="server" ID="ddlFromSave" ClientIDMode="Static" DataTextField="SaveName" DataValueField="SaveId"
                                            AutoPostBack="True" OnSelectedIndexChanged="DdlFromBox_SelectedIndexChanged" Width="178px" />
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right">
                                <asp:Literal ID="Literal5" runat="server" Text="<%$Resources:Tokens,To %>"></asp:Literal></label>
                            <div class="col-sm-9">
                                <div>
                                    <div>
                                        <asp:DropDownList runat="server" ID="ddlToSave" AutoPostBack="True" OnTextChanged="DdltoBox_SelectedIndexChanged" ClientIDMode="Static" DataTextField="SaveName" DataValueField="Id" Width="178px" />
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right">
                                <asp:Literal ID="Literal8" runat="server" Text="<%$Resources:Tokens,Amount %>"></asp:Literal></label>
                            <div class="col-sm-9">
                                <div>
                                    <div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right">
                                <asp:Literal ID="Literal9" runat="server" Text="<%$Resources:Tokens,Notes %>"></asp:Literal></label>
                            <div class="col-sm-9">
                                <div>
                                    <div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <i class="icon-ok bigger-110">
                                    <asp:Button ID="save_b" runat="server" Text="<%$ Resources:Tokens,Add.Request %>" CssClass="btn btn-info"

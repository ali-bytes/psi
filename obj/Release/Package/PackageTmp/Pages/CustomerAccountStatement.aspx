<%@ Page Title="<%$Resources:Tokens,CustomerAccountStatement %>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="CustomerAccountStatement.aspx.cs" Inherits="NewIspNL.Pages.CustomerAccountStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link rel="stylesheet" href="../Content/ace-assest/css/chosen.css" type="text/css"/>
     <div class="page-header" >
                <h1><asp:Literal ID="Literal8" runat="server" Text="<%$Resources:Tokens,CustomerAccountStatement %>"></asp:Literal>
                </h1>
            </div>
       ...
       <div class="well">
                        <div>
                            <label>
                                <asp:Literal runat="server" ID="lblstores" Text="<%$Resources:Tokens,Customers %>"></asp:Literal></label>
                            <div>
                                 <asp:DropDownList runat="server" ID="ddlCustomer" ClientIDMode="Static" CssClass="chosen" DataTextField="CustomerName" DataValueField="Id"/>

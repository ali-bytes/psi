<%@ Page Title="<%$Resources:Tokens,SearchAboutBranchInvoice %>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="SearchAboutBranchInvoice.aspx.cs" Inherits="NewIspNL.Pages.SearchAboutBranchInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <fieldset>
            <div class="page-header"><h1>
                <asp:Literal ID="Literal1" Text="<%$Resources:Tokens,SearchAboutBranchInvoice %>" runat="server" /></h1></div>
            <div class="well">

<%@ Page Title="<%$Resources:Tokens,ResellerEvaluation%>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="ResellerEvaluation.aspx.cs" Inherits="NewIspNL.Pages.ResellerEvaluation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="view"  >
        <fieldset style="float: right ;">
            <div class="page-header"><h1>
                <%= Tokens.ResellerEvaluation%></h1></div>
            <div class="well" >
              <div >
                <div>
                    ...
                    <div>
                        <asp:DropDownList runat="server" ID="DdlReseller" ClientIDMode="Static" Width="178px">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RTbReseller" ErrorMessage="<%$Resources:Tokens,Required %>"
                                                    ControlToValidate="DdlReseller" runat="server" />
                    </div>
                </div>
                <div>
                    <label for="TbStartAt">
                ...
                <p><br/>
                    <button runat="server" id="BSearch" class="btn btn-success">
                        <i class="icon-only icon-search"></i>&nbsp;<%= Tokens.Search %></button>
                </p></div>
           ...
           <div style="height: 60px">
            <div style="float: right ;margin-left: 125px; margin-top: 10px;"  >
            <h4 class="blue">
                <asp:Literal runat="server" Text="<%$Resources:Tokens,Active %>"></asp:Literal>
            </h4></div>
 ...
 <div class="well" >
     <div class="text-center"  style="float: right">
         <h3 class="header smaller lighter blue"><asp:Literal runat="server" Text="<%$Resources:Tokens,grafnew %>"></asp:Literal></h3>
...
<AxisX LineColor="DarkGray">
    	...
    	<fieldset>
            ...
            <div class="center" runat="server" id="divcustomerCount" Visible="False">
                                            <span class="btn btn-app btn-info no-hover" style="border-radius: 5px;">
                                                ...
                                                <br/>
													<span class="line-height-1 smaller-90"> <asp:Literal runat="server" Text="<%$Resources:Tokens,CustomersCount %>" ></asp:Literal> </span>
												</span></div>
    ...
    <div class="view">
        ...
        <div>
            <asp:GridView runat="server" ID="GvToNewCustomer" AutoGenerateColumns="False" CssClass="table table-bordered table-condensed text-center">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
    ...
    <div class="view">
        <fieldset>
            ...
            <asp:GridView runat="server" ID="GvSuspend" AutoGenerateColumns="False" CssClass="table table-bordered table-condensed text-center">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Label ID="LNo" runat="server" />
    ...
    <div class="view">
        ...
        <div>
            <asp:GridView runat="server" ID="GvCancelled" AutoGenerateColumns="False" CssClass="table table-bordered table-condensed text-center">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Label ID="LNo" runat="server" />

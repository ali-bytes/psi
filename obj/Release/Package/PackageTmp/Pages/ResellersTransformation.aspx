<%@ Page Title="<%$Resources:Tokens,ResellersTransformation%>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="ResellersTransformation.aspx.cs" Inherits="NewIspNL.Pages.ResellersTransformation" %>
    ...
    <div class="view">
        ...
        <div class="col-sm-12">
            <div class="form-horizontal">
                ...
                <label class="col-sm-3 control-label no-padding-right"><asp:Literal ID="Literal3" runat="server" Text="<%$Resources:Tokens,Reseller %>"></asp:Literal></label>
                <div class="col-sm-9">
                <div>
                    <div>
                        <asp:DropDownList runat="server" CssClass="width-60 chosen-select" ID="ddlReseller" ClientIDMode="Static" Width="200px">
                        </asp:DropDownList>

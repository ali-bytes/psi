<%@ Page Title="<%$Resources:Tokens,PendingCalls%>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="PendingCalls.aspx.cs" Inherits="NewIspNL.Pages.PendingCalls" %>
    ...
    <div class="view">
        ...
        <div>
            <asp:Panel runat="server" ID="containerPanel" ClientIDMode="Static">
                <div class="page-header"><h1><asp:Literal runat="server" Text="<%$Resources:Tokens,PendingCalls%>"></asp:Literal></h1></div>
                ...
                <div id="reject" style="padding: 15px;">
                    <fieldset>
                        <h3 class="header smaller lighter blue">
                            <asp:Label runat="server" Text="<%$Resources:Tokens,Reject%>" ID="Label13"></asp:Label></h3>
                        <div>
                            <div>
                            ...
                            <p>
                                ...
                                <asp:Button runat="server" Text="<%$Resources:Tokens,Save%>" ID="b_saveReject" OnClick="b_saveReject_Click"
                                    Width="90px" ValidationGroup="reject" CssClass="btn btn-primary" />
                            </p>
                        </div>
                    </fieldset>
                </div>

<%@ Page Title="<%$Resources:Tokens,TransfaresFromSaves%>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="TransfaresFromSaves.aspx.cs" Inherits="NewIspNL.Pages.TransfaresFromSaves" %>
    ...
    <div class="view">
        <fieldset>
            <div class="page-header"><h1>
                <asp:Literal ID="Literal1" Text="<%$Resources:Tokens,TransfaresFromSaves %>" runat="server" /></h1></div>
...
<div class="form-group">
                ...
                <div>
                    <div>
                        <asp:DropDownList runat="server" ID="ddlToSave" AutoPostBack="True" OnTextChanged="DdltoBox_SelectedIndexChanged" ClientIDMode="Static" DataTextField="SaveName" DataValueField="SaveId" Width="178px"/>

<%@ Page Title="<%$Resources:Tokens,HandelBranchesTransfers %>" Language="C#" MasterPageFile="~/Pages/AwesomeMaster.Master" AutoEventWireup="true" CodeBehind="HandelBranchesTransfers.aspx.cs" Inherits="NewIspNL.Pages.HandelBranchesTransfers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-header">
        <h1>
            <asp:Literal runat="server" ID="lbltitle" Text="<%$Resources:Tokens,HandelBranchesTransfers %>"></asp:Literal></h1>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div>
                <asp:DropDownList runat="server" CssClass="width-60 chosen-select" ID="ddlBranch" Width="150px" ClientIDMode="Static">
                </asp:DropDownList>
